...
Finally, we obtained a smaller corpus per framework (see the table above).
...
is the National Institutes of Health (ur data does not include 
...
``students'', ``research'', ``study'', ``program'', ``development'', ``study'', ``studies'', ``provide'', ``use'', ``understanding'', ``important'', ``support'', ``proposed''. We also removed the rare words that appear less than 5 
